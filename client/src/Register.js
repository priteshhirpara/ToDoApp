  ...
  return (
    <div className="register-container" id="register-block">
      <form className="register-form" onSubmit={handleRegisterSubmit}>
        ...
        <div className="form-group">
          <br />
          <span style={userName.length === 0 ? { color: 'red' } : { color: 'green' }}>Username should not be EMPTY</span>
          <br />
          ...
          <span
            style={
              userPassword !== userConfirmPassword || userPassword.length === 0 || userConfirmPassword.length === 0
                ? { color: 'red' }
                : { color: 'green' }
            }
          >
        ...
        <div className="form-group">
          <a href="#login-block" className="link-button">
            Login
          </a>
        </div>
      </form>
